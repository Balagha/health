  ...
  return (
    <div className="sm:hidden text-[#757575]">
      <div className="px-1 pb-4 space-y-1">
        ...
        <a
          href="/#"
          className="text-#393939-300 hover:text-[#a5c422] pl-10 py-2 text-sm font-medium"
        >
          <img
            className="w-5 inline-block mr-3"
        ...
        <a
          href="/#"
          className="flex justify-center text-#393939-300 hover:text-[#a5c422] px-3 py-2 text-sm font-medium"
        >
          <img
            className="w-5 inline-block mr-3"
