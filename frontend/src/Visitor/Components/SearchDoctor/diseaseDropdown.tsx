  ...
  return (
    <div className="h-9 mr-2">
        <button
                ...
                type="button">Select Disease<svg className="ml-2 w-4 h-4" aria-hidden="true" fill="none"
        ...
        {showOptions &&(
            <div id="dropdown"
                ...
                <ul className="block py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                    <li>
                        <a href="#"
