        ...
        <div className="top_nav">
            <div className="nav_menu">
                <div className="nav toggle">
                    <a href="/#" id="menu_toggle"><i className="fa fa-bars"></i></a>
                </div>
                <nav className="nav navbar-nav">
                    <ul className="navbar-right">
                        <li className="nav-item dropdown open" style={{paddingLeft: 15}}>
                            <a href="javascript" className="user-profile dropdown-toggle" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
